...
public:
	...
	// Scoped conversion helper: RGB Green 5-bit to 8-bit
	static uint8_t Green5To8(const uint16_t val)
	{
		const auto green5 = (val & g5_mask) >> g5_offset;
		return static_cast<uint8_t>(rgb5_to_8_lut(green5));
	}
