...
struct SDL_Block {
	...
	// True when the contents of the framebuffer has been changed in the current frame.
	// E.g., we only need to upload new texture data when this flag is true in GFX_EndUpdate().
	bool updating = false;
