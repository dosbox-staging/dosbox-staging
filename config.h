...
/* Define to 1 to use recompiling cpu core. Can not be used together with the
   dynamic-x86 core */
#ifdef _ANDROID_
#if __arm__ || __aarch64__ || __i386__
...
#else
#define PACKAGE_TARNAME "ldosbox"
#endif
...
#define ANDROID_MSG_SCREENSHOT 102
#define ANDROID_MSG_DRIVE_RO 103
extern void JavaExit();
extern void JavaToastMessage(const char *message, int level=0);
extern void JavaFatalError(const char *message);
#define SDL_ANDROID_CHECK_EVENT(ev) \
	if (SDL_CompatManageEvent(ev)) continue; \
	if (MousePadManageEvent(ev)) continue;
#endif
//to have tracing with myLog
//#define _LOG_
