...
#define LORES_SCANLINE_STRENGTH_MIN 0.70
#define LORES_SCANLINE_STRENGTH_MAX 0.90
#define LORES_COLOR_BOOST_EVEN 5.0
#define LORES_COLOR_BOOST_ODD 1.5
#define LORES_MASK_STRENGTH 0.1
#define LORES_GAMMA_INPUT 2.2
#define LORES_GAMMA_OUTPUT 2.2

#define HIRES_SCANLINE_STRENGTH_MIN 0.86
#define HIRES_SCANLINE_STRENGTH_MAX 0.95
#define HIRES_COLOR_BOOST_EVEN 11.0
#define HIRES_COLOR_BOOST_ODD 2.1
#define HIRES_MASK_STRENGTH 0.1
#define HIRES_GAMMA_INPUT 2.2
#define HIRES_GAMMA_OUTPUT 2.3
