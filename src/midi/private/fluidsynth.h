...
#ifndef DOSBOX_PRIVATE_FLUIDSYNTH_H
#define DOSBOX_PRIVATE_FLUIDSYNTH_H
...
private:
	...
	// internal clock doesn't advance during a DOSBox pause.
...
#endif // DOSBOX_PRIVATE_FLUIDSYNTH_H
