...
static void notify_fluidsynth_setting_updated(SectionProp* section,
                                              const std::string& prop_name)
{
	const auto device = dynamic_cast<MidiDeviceFluidSynth*>(MIDI_GetCurrentDevice());
	assert(device);
	...
	} else if (prop_name == "fsynth_volume") {
		// TODO
