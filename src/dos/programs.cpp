...
void PROGRAMS_MakeFile(const char* name, PROGRAMS_Creator creator)
{
	...
	// Enlarge the executable, so that we are sure the memory resize call in
	// the 'exe_block' succeeds; otherwise, if our program falls into a
	// small memory hole, our stack might override someone else's data.
