...
void TREE::AddMessages()
{
	MSG_Add("PROGRAM_TREE_HELP_LONG",
	        ...
	        "  /f        also displays files.\n"
	        "  /p        displays one page a time, shorten output to fit screen width.\n"
	        "  /da       displays attributes.\n"
	        "  /df       displays size for files.\n"
	        "  /dh       also displays hidden and system files/directories.\n"
