...
void INTRO::AddMessages()
{
    ...
    MSG_Add("PROGRAM_INTRO_MOUNT_START",
	    "[erases=entire][color=light-green]Commands to get you started[reset]\n"
	    "\n"
    ...
    MSG_Add("PROGRAM_INTRO_MOUNT_WINDOWS",
	    "[color=light-blue]mount c c:\\dosgames\\ [reset]will create a C drive with c:\\dosgames as contents.\n"
	    "\n"
	    "[color=light-blue]c:\\dosgames\\ [reset]is an example. Replace it with your own games directory.\n");

    MSG_Add("PROGRAM_INTRO_MOUNT_OTHER",
	    "[color=light-blue]mount c ~/dosgames[reset] will create a C drive with ~/dosgames as contents.\n"
	    "\n"
	    "[color=light-blue]~/dosgames[reset] is an example. Replace it with your own games directory.\n");
    ...
    MSG_Add("PROGRAM_INTRO_MOUNT_END",
	    ...
	    "You can run programs/files with extensions [color=light-green].exe .bat[reset] and [color=light-green].com[reset].\n");

    MSG_Add("PROGRAM_INTRO_CDROM_WINDOWS",
	    "[erases=entire][color=light-green]Mounting directories as CD-ROM drives[reset]\n"
	    "\n"
	    ...
	    "\n"
	    "[color=light-green]Mounting CD-ROM images[reset]\n"
	    "\n"
