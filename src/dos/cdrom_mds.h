...
inline std::optional<MdsHeader> read_mds_header(std::ifstream &stream, std::ifstream::pos_type pos)
{
	stream.seekg(pos);
	if (stream.fail()) {
		return {};
...
inline std::optional<MdsSessionBlock> read_mds_session_block(std::ifstream &stream, std::ifstream::pos_type pos)
{
	stream.seekg(pos);
	if (stream.fail()) {
		return {};
...
inline std::optional<MdsTrackBlock> read_mds_track_block(std::ifstream &stream, std::ifstream::pos_type pos)
{
	stream.seekg(pos);
	if (stream.fail()) {
		return {};
...
inline std::optional<MdsExtraBlock> read_mds_extra_block(std::ifstream &stream, std::ifstream::pos_type pos)
{
	stream.seekg(pos);
	if (stream.fail()) {
		return {};
...
inline std::optional<MdsFooter> read_mds_footer(std::ifstream &stream, std::ifstream::pos_type pos)
{
	stream.seekg(pos);
	if (stream.fail()) {
		return {};
