...
private:
	...
	Bit8u numParam = 0, neededParam = 0; // Numbers of parameters already
	...
	Real64 cpi = 0.0, actcpi = 0.0; // CPI value set by program and the actual
	...
	{
		Bit16u horizDens = 0, vertDens = 0; // Density of image to print
		                                    // (in dpi)
		...
		Bit8u readBytesColumn = 0; // Bytes read so far for the current
		                           // column
	} bitGraph;

	Bit8u densk = 0, densl = 0, densy = 0, densz = 0; // Image density modes
	                                                  // used in ESC K/L/Y/Z
	                                                  // commands
	...
	Bit16u numPrintAsChar = 0; // Number of bytes to print as characters
