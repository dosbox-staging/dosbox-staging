...
static void init_mouse_config_settings(SectionProp& secprop)
{
	...
	prop_str = secprop.AddString("builtin_dos_mouse_driver", OnlyAtStart,
	...
	prop_str->SetHelp(
	        ...
	        "\n"
	        "  auto:    Pick 'on' or 'no-tsr', whichever is more suitable to the configured\n"
	        "           machine type (default).\n"
		"\n"
	        "  on:      Use a little Upper or Conventional memory (much less than any real\n"
	        "           DOS mouse driver) to simulate a driver TSR program loaded from\n"
	        "           AUTOEXEC.BAT. This is the most realistic way to emulate the DOS\n"
	        "           mouse driver, needed for proper mouse support in DOS applications\n"
	        "           running under Windows 3.1x. If it doesn't work with your game, try\n"
	        "           the 'no-tsr' setting.\n"
	        "\n"
