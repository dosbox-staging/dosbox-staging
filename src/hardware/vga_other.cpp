...
constexpr uint8_t mono_cga_palettes[8][16][3] = {
	{
		// 0 - Green, 4-colour-optimised contrast
		...
		// 1 - Green, 16-colour-optimised contrast
		...
		// 2 - Amber, 4-colour-optimised contrast
		...
		// 3 - Amber, 16-colour-optimised contrast
		...
		// 4 - Gray, 4-colour-optimised contrast
		...
		// 5 - Gray, 16-colour-optimised contrast
		...
		// 6 - Paper-white, 4-colour-optimised contrast
		...
		// 7 - Paper-white, 16-colour-optimised contrast
