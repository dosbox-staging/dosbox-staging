...
constexpr uint8_t mono_cga_palettes[8][16][3] = {
	{
		...
		// 1 - Amber, 16-colour-optimised contrast
		...
		// 2 - Green, 4-colour-optimised contrast
		...
		// 3 - Green, 16-colour-optimised contrast
		...
		// 4 - White, 4-colour-optimised contrast
		...
		// 5 - White, 16-colour-optimised contrast
		...
		// 6 - Paperwhite, 4-colour-optimised contrast
		...
		// 7 - Paperwhite, 16-colour-optimised contrast
