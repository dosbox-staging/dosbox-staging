...
static BlockReturn gen_runcodeInit(Bit8u *code) {
	...
	/* NTS: For VS2019, mere typecasting won't correctly detect whether the
	        pointer is small enough to fit in 32 bits. We have to mask and
	        compare. If the pointer is above 4GB and the wrong choice is
	        made, dynamic core will crash. --J.C. */
