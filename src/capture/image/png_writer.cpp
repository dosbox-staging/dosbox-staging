                           ...
                           const VideoMode& video_mode)
{
	...
	constexpr auto PaletteData = nullptr;
	WritePngInfo(width, height, pixel_aspect_ratio, video_mode, IsPaletted, PaletteData);
	return true;
}
                             ...
                             const VideoMode& video_mode, const uint8_t* palette_data)
{
	...
	WritePngInfo(width, height, pixel_aspect_ratio, video_mode, IsPaletted, palette_data);
	return true;
}
