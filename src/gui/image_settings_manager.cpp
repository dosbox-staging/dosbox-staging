...
static AutoImageSettings monochrome_settings = {CrtColorProfile::None, 6500};
static AutoImageSettings composite_settings  = {CrtColorProfile::SmpteC, 6500};

static AutoImageSettings cga_settings = {CrtColorProfile::P22, 9300};
static AutoImageSettings ega_settings = {CrtColorProfile::P22, 9300};
static AutoImageSettings vga_settings = {CrtColorProfile::Trinitron, 6500};

static AutoImageSettings arcade_settings = {CrtColorProfile::Philips, 6500};

std::optional<AutoImageSettings> ImageSettingsManager::GetSettings(const VideoMode& video_mode)
{
...
AutoImageSettings ImageSettingsManager::GetAutoMachineSettings(const VideoMode& video_mode) const
{
...
AutoImageSettings ImageSettingsManager::GetAutoGraphicsStandardSettings(
