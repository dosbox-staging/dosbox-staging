...
uint32_t Deinterlacer::DetectBackgroundColor(const uint32_t* pixel_data) const
{
	...
	// scanlines" also have this colour instead of 100% black.
	//
	...
	// into a detection heuristics: we assume the top left pixel colour is
	// the background colour, and if the next 10 lines are filled with this
	// colour, we conclude this must be the background colour.
	//
