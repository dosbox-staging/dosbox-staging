...
The following uniform are passed to the shader passes:
...
named `INPUT_SIZE_0`, `INPUT_SIZE_1`, etc. The textures are
...
default to `input0 Previous`. Consequently, the `INPUT_SIZE_0` and
