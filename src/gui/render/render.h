...
struct ImageAdjustmentSettings {
	...
	// Gamma control. Valid range between -0.4 and 1.4; 0.0 means no change.
	float gamma = 0.0f;
	...
	// the white point and lighter shades become.
	float color_temperature_luma_preserve = 0.7f;

	// Gain of the red channel. Valid range between 0.0 and 1.0; 1.0 means
	// no change.
	float red_gain = 1.0f;

	// Gain of the green channel. Valid range between 0.0 and 1.0; 1.0 means
	// no change.
	float green_gain = 1.0f;

	// Gain of the blue channel. Valid range between 0.0 and 1.0; 1.0 means
	// no change.
