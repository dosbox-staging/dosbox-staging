                                            ...
                                            const uint32_t sdl_window_flags)
{
	...
	// Request an OpenGL 4.3 core profile context (debug output became a core part of
	// OpenGL since version 4.3). Note the macOS doesn't seem to support debug contexts at all.
