...
void OpenGlRenderer::UpdatePass1Uniforms()
{
	...
	glUniform1i(u.enable_adjustments,
	            static_cast<GLint>(pass1.enable_image_adjustments ? 1 : 0));

	glUniform1i(u.color_profile,
	            static_cast<GLint>(enum_val(s.crt_color_profile)));
	...
	glUniform1f(u.digital_contrast, static_cast<GLfloat>(s.digital_contrast));
	...
	glUniform3f(u.black_level_color,
	            static_cast<GLfloat>(s.black_level_color.red) / RgbMaxValue,
	            static_cast<GLfloat>(s.black_level_color.green) / RgbMaxValue,
	            static_cast<GLfloat>(s.black_level_color.blue) / RgbMaxValue);
