...
{
	this->draw_rect_px = draw_rect_px;
                                      ...
                                      const int new_render_height_px)
{
	...
	pitch = render_width_px * MaxBytesPerPixel;
...
//
GLuint OpenGlRenderer::BuildShader(const GLenum type, const std::string& source)
{
	GLuint shader            = 0;
...
bool OpenGlRenderer::ReadPixelsPostShader(const DosBox::Rect output_rect_px,
