...
void SHELL_InitAndRun()
{
	...
	MSG_Add("SHELL_CMD_APPEND_HELP_LONG",
	        ...
	        "Parameters:\n"
	        "  [color=light-cyan][[DRIVE:]PATH[;...]][reset]  path(s) containing a drive and directory\n"
	        "  [color=light-cyan]/X[reset] or [color=light-cyan]/X:ON[reset]       Applies appended directories to application execution as well as data files.\n"
	        "  [color=light-cyan]/X:OFF[reset]              Applies appended directories only to data files (default).\n"
	        "  [color=light-cyan]/E[reset]                  Alias for /X:ON (kept for MS-DOS compatibility).\n"
	        "\n"
	        "Notes:\n"
	        "  - More than one path can be specified, separated by a semi-colon (;).\n"
