...
// XXX comment, add info about order
// XXX remove duplicates?

namespace Iso639 {

// XXX add preferrences
...
static const std::unordered_map<std::string, std::set<std::string>> IsoToKeyboardLayouts = {
	...
	{ Iso639::Belarusian,       { "by", "bl"                   } },
	{ Iso639::Bosnian,          { "ba"                         } },
	{ Iso639::Breton,           { "uk,", "uk168"               } },
	{ Iso639::Bulgarian,        { "bg", "bg103", "bg241"       } },
	{ Iso639::Catalan,          { "es", "sp", "it", "it142"    } },
	{ Iso639::Chechen,          { "ce", "ce443"                } },
	{ Iso639::Cherokee,         { "us"                         } },
	{ Iso639::ChurchSlavonic,   { "ru", "ru443", "rx", "rx443" } },
	{ Iso639::Cree,             { "cf", "ca", "cf445"          } },
	{ Iso639::Croatian,         { "hr"                         } },
	{ Iso639::Czech,            { "cz489", "cz243", "cz"       } },
	{ Iso639::Danish,           { "dk"                         } },
	{ Iso639::Dutch,            { "nl"                         } },
	{ Iso639::Esperanto,        { "gr453", "tr", "tr440"       } },
	{ Iso639::Estonian,         { "ee", "et"                   } },
	{ Iso639::Faroese,          { "fo", "dk"                   } },
	{ Iso639::Finnish,          { "fi", "su"                   } },
	{ Iso639::Fon,              { "bn"                         } },
	{ Iso639::Frankish,         { "be"                         } },
	{ Iso639::French,           { "fr", "fx"                   } },
	{ Iso639::WesternFrisian,   { "gr", "de", "gr453", "nl"    } },
	{ Iso639::Gaelic,           { "uk,", "uk168"               } },
	{ Iso639::Georgian,         { "ka"                         } },
	{ Iso639::German,           { "de", "gr", "gr453"          } },
	{ Iso639::Greek,            { "gk", "el", "gk220", "gk459" } },
	...
	{ Iso639::Luxembourgish,    { "us", "de", "gr", "gr453"    } },
	{ Iso639::Macedonian,       { "mk"                         } },
	{ Iso639::Maltese,          { "mt", "ml", "mt103"          } },
	{ Iso639::Manx,             { "uk,", "uk168"               } },
	{ Iso639::Mongolian,        { "mn", "mo"                   } },
	{ Iso639::Norwegian,        { "no"                         } },
	...
	{ Iso639::NorthernSami,     { "su", "fi", "no", "sv"       } },
	{ Iso639::Sardinian,        { "it", "it142"                } },
	{ Iso639::Serbian,          { "yc", "sr", "yc450"          } },
	{ Iso639::Slovak,           { "sk"                         } },
	{ Iso639::Slovenian,        { "si"                         } },
	{ Iso639::Spanish,          { "es", "sp", "sx", "la"       } },
	{ Iso639::Swedish,          { "sv"                         } },
	{ Iso639::Tagalog,          { "ph"                         } },
	{ Iso639::Tajik,            { "tj"                         } },
	...
	{ Iso639::Turkmen,          { "tm"                         } },
	{ Iso639::Ukrainian,        { "ur", "ua", "ur2007", "ur2001", "ur1996", "ur465" } },
	{ Iso639::Uzbek,            { "uz"                         } },
	...
	// English
	{ Iso639::English + Iso3166::UnitedStates,  { "us", "ux", "co", "dv", "lh", "rh" } },
	{ Iso639::English + Iso3166::UnitedKingdom, { "uk", "uk168", "kx" } },
	...
	{ Iso639::Spanish    + "_" + Iso3166::Spain,    { "es", "sp"    } },

	// Beninese / Canadian / Nigerien French
	{ Iso639::French + "_" + Iso3166::Benin,   { "bn"                } },
	{ Iso639::French + "_" + Iso3166::Canada,  { "cf", "ca", "cf445" } },
	...
	// Swiss German / French
	{ Iso639::German + "_" + Iso3166::Switzerland, { "sd", "sg" } },
	...
	{ Iso639::Neuer,        { "ux", "kx", "fx", "px", "bx", "sx" } },	
...
/* XXX
	...
	- XXX: https://gitlab.com/FreeDOS/base/keyb_lay/-/blob/master/DOC/KEYB/LAYOUTS/ENHANCED.TXT
	...
	// XXX https://en.wikipedia.org/wiki/List_of_ISO_639-2_codes


extern const std::string Avaric; XXX cyrillic
extern const std::string Haitian; // XXX variant of french
