...
vec3 getadvinterp3xtexel(vec2 coord)
{
	...
	vec3 c0 = texture(INPUT_TEXTURE_0, (base - vec2(1.0, 1.0)) / INPUT_TEXTURE_SIZE_0).xyz;
	vec3 c1 = texture(INPUT_TEXTURE_0, (base - vec2(0.0, 1.0)) / INPUT_TEXTURE_SIZE_0).xyz;
	vec3 c2 = texture(INPUT_TEXTURE_0, (base - vec2(-1.0, 1.0)) / INPUT_TEXTURE_SIZE_0).xyz;
	...
	vec3 c6 = texture(INPUT_TEXTURE_0, (base + vec2(-1.0, 1.0)) / INPUT_TEXTURE_SIZE_0).xyz;
	vec3 c7 = texture(INPUT_TEXTURE_0, (base + vec2(0.0, 1.0)) / INPUT_TEXTURE_SIZE_0).xyz;
	vec3 c8 = texture(INPUT_TEXTURE_0, (base + vec2(1.0, 1.0)) / INPUT_TEXTURE_SIZE_0).xyz;
