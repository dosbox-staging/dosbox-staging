...
vec3 eotf_1886a(vec3 color, float black_level, float brightness, float contrast)
{
	color.r = eotf_1886a(color.r,
	                     BLACK_LEVEL_COLOR.r > 0
	                             ? (black_level * BLACK_LEVEL_COLOR.r * 100)
	                             : black_level,
	                     brightness,
	                     contrast);

	color.g = eotf_1886a(color.g,
	                     BLACK_LEVEL_COLOR.g > 0
	                             ? (black_level * BLACK_LEVEL_COLOR.g * 100)
	                             : black_level,
	                     brightness,
	                     contrast);

	color.b = eotf_1886a(color.b,
	                     BLACK_LEVEL_COLOR.b > 0
	                             ? (black_level * BLACK_LEVEL_COLOR.b * 100)
	                             : black_level,
	                     brightness,
	                     contrast);
...
void main()
{
	...
	color *= vec3(RED_GAIN * RED_GAIN, GREEN_GAIN * GREEN_GAIN, BLUE_GAIN * BLUE_GAIN);
