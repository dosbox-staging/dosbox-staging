...
The DOS era spanned roughly 15 years with dramatically different hardware in
each period. Games are designed for the hardware of their time, so matching
the emulated hardware to the game's era gives the best results. See
[The DOS eras](dos-eras.md) for period-correct configurations and historical
context.
