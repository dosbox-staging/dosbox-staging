...
- [country](dos.md#country) — set the DOS country code for
  date/time/number formatting
- [keyboard_layout](dos.md#keyboard_layout) — set the DOS keyboard
  layout
- [locale_period](dos.md#locale_period) — use a period as the
...
[language](general.md#language) for details.
