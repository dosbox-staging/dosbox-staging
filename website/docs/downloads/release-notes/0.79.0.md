...
<figure markdown>
  ![Defender of the Crown (default)](images/dotc-default.png){ loading=lazy }
...
<figure markdown>
  ![Defender of the Crown (tandy-warm)](images/dotc-tandy-warm.png){ loading=lazy }
...
<figure markdown>
  ![Gold Rush! (default)](images/gold-rush-default.png){ loading=lazy }
...
<figure markdown>
  ![Gold Rush! (agi-amigaish)](images/gold-rush-agi-amigaish.png){ loading=lazy }
...
<figure markdown>
  ![Zak McKracken (default)](images/zak-default.png){ loading=lazy }
...
<figure markdown>
  ![Zak McKracken (colodore)](images/zak-colodore.png){ loading=lazy }
...
<figure markdown>
  ![Timequest (good)](images/timequest-good.png){ loading=lazy }
...
<figure markdown>
  ![Timequest (bad)](images/timequest-bad.png){ loading=lazy }
...
<figure markdown>
  ![Space Quest III (good)](images/sq3-good.png){ loading=lazy }
...
<figure markdown>
  ![Space Quest III (bad)](images/sq3-bad.png){ loading=lazy }
...
<figure markdown>
  ![Windwalker (good)](images/windwalker-good.png){ loading=lazy }
...
<figure markdown>
  ![Windwalker (bad)](images/windwalker-bad.png){ loading=lazy }
...
<figure markdown>
  ![DOSBox Staging on macOS without high DPI support](images/non_hidpi_win31.png){ loading=lazy }
...
<figure markdown>
  ![DOSBox Staging on macOS with high DPI support](images/hidpi_win31.png){ loading=lazy }
...
<figure markdown>
  ![DIR command (CF)](images/country_code_2.png){ loading=lazy }
...
<figure markdown>
  ![DIR command (US)](images/country_code_1.png){ loading=lazy }
...
<figure markdown>
  ![Windows installer welome page](images/windows_installer_start.png){ loading=lazy }
...
<figure markdown>
  ![Icons after installation](images/icons_after_installation.png){ loading=lazy }
