...
<figure markdown>
  ![HoMM2](images/homm2-pp-2x2.png)
  <figcaption>Heroes of Might and Magic 2 (1996) &mdash; 640&times;480 with a <a href="https://en.wikipedia.org/wiki/Pixel_aspect_ratio">pixel aspect ratio (PAR)</a> of 1:1, upscaled to 2&times;2</figcaption>
</figure>

<figure markdown>
  ![Wolf3D](images/wolf3d-pp-4x5.png)
  <figcaption>Wolfenstein 3D (1992) &mdash; 320&times;200 with a PAR of 1:1.2 (non-square pixels), upscaled to 4&times;5 with a PAR of 1:1.25</figcaption>
</figure>
...
<figure markdown>
  ...
  <figcaption>Star Wars: Dark Forces (1995) intro playing while the DOSBox window is being resized vigorously</figcaption>
</figure>
...
<figure markdown>
  ![Battle Chess](images/bc.png)
  <figcaption>Battle Chess (1988) &mdash; at 1080p using the default settings</figcaption>
</figure>
...
This improved accuracy comes at a slightly higher CPU use-cost, which is
insignificant for the vast majority of users on typical desktop or laptop
hardware.
...
<figure markdown>
  ...
  <figcaption>Stargunner (1996, freeware) &mdash; running on Linux x86\_64 via Boxtron</figcaption>
</figure>
...
<figure markdown>
  ![CGA modes comparison](images/cga-showcase-1.png)
  <figcaption>Maniac Mansion (1987) &mdash; with forced CGA mode:<br>
...
<figure markdown>
  ![X-Wing Collector's Edition](images/xwingce-lottes.png)
  <figcaption>Star Wars™ &ndash; X-Wing: Collector's CD-ROM Edition (1994)<br>
    Using CRT-Lottes shader on a 1080p screen; click on the image to enlarge
    it to see the fine details. This shader is not bundled with DOSBox Staging
    (yet); you can download it from <a href="https://github.com/tyrells/dosbox-svn-shaders">here</a>
  </figcaption>
</figure>
...
Submit new issues or learn more about existing ones using our [bug-tracker](https://github.com/dosbox-staging/dosbox-staging/issues).
