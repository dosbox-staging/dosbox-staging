...
upgrading to the latest FluidSynth version. The panning of some instruments was
off-centre, slightly leaning to the left. The problem could be rather subtle
...
"buggy" audio below recorded using the previous 0.80.1 DOSBox
Staging version.
