...
See [The DOS shell](shell.md) to learn about the shell itself --- line
editing, tab completion, command history, piping, and other interactive
features.
...
[automounted](../system/dos.md#automount) (enabled by default), the
