...
[`floppy_disk_speed`](../system/overview.md#floppy_disk_speed) and
[`hard_disk_speed`](../system/overview.md#hard_disk_speed) settings). The
...
`resources/disk-noises` folder, as long as they are in 22 kHz format.
...
:   Enable emulated floppy disk noises. Plays spinning disk and seek noise
    ...
    [`floppy_disk_speed`](../system/overview.md#floppy_disk_speed) to lower than
...
:   Enable emulated hard disk noises. Plays spinning disk and seek noise
    sounds when enabled. It's recommended to set
    [`hard_disk_speed`](../system/overview.md#hard_disk_speed) to lower than
    `maximum` for an authentic experience.
