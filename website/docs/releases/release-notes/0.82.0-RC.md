...
values instead of the chip's native power-on state. Most games don't care
...
- Windows CD-ROM audio now gets routed through the DOSBox mixer,
  bringing it to feature parity with Linux.
