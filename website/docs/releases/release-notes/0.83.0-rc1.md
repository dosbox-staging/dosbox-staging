...
!!! warning "Release candidate notes"
    ...
    willing to help us stabilise DOSBox Staging for the final release. If
    you’ve found any issue in the RC, please [report it to
    us!](../../get-involved/index.md#report-an-issue)
...
!!! warning "Legal notes"
    ...
    _strictly prohibited_ for the creating commercial Roland SC-55 emulation
...
??? note "Full PR list of miscellaneous enhancements"
    ...
    - Change default webserver port from 8080 to 8386 (#4881)
