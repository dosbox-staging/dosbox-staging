...
guide](../../getting-started/index.md) to the front page. The guide will teach
you how to set up your own DOSBox Staging environment from scratch through
easy-to-follow instructions with lots of pretty pictures. It adopts a
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/gods.jpg",
    "Gods — 320×200 VGA"
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/ultima-underworld.jpg",
    "Ultima Underworld: The Stygian Abyss —<br>320×200 VGA"
) }}
</div>

<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/celtic-tales.jpg",
    "Celtic Tales: Balor of the Evil Eye --- 640×480 VGA"
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/dark-seed.jpg",
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/monkey-island.jpg",
    "The Secret of Monkey Island --- 320×200 EGA"
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/space-quest-iii.jpg",
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/wizardry.jpg",
    "Wizardry: Proving Grounds of the Mad Overlord --- 320×200 CGA"
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/smoker.jpg",
    "Smoker by Fairfax ---<br>320×200 15kHz \"arcade\" shader"
) }}
</div>

<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/zak.jpg",
    "Zak McKracken and the Alien Mindbenders ---<br>320×200 CGA composite"
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/starblade.jpg",
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/pop-hercules.png",
    "Prince of Persia without any custom stretching",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/pop-hercules-aspect-corrected.jpg",
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/multikolor-buggy.png",
    "Multikolor by kolor --- Black vertical bars issue",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/multikolor-fixed.png",
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/angel-devoid-raw.png",
    "Angel Devoid: Face of the Enemy --- Raw output",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/angel-devoid-fixvideo.png",
    "With the `misc/fixvideo` shader",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/angel-devoid-fixvideo-scanline.png",
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/mixer-listmidi.png",
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.81.0/macos-logging-shortcut.png",
    alt="New run with log window macOS shortcut",
    small=False,
    width="85%"
) }}
