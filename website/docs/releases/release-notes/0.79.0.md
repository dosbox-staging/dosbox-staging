...
- [Linux](../linux.md) (or [Steam on Linux](../linux.md))
- [Windows](../windows.md)
- [macOS](../macos.md)
...
effects](#reverb-and-chorus), the FluidSynth `reverb` and `chorus` config
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/dotc-default.png",
    "`cga_colors = default`",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/dotc-tandy-warm.png",
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/gold-rush-default.png",
    "`cga_colors = default`",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/gold-rush-agi-amigaish.png",
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/zak-default.png",
    "`cga_colors = default`",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/zak-colodore.png",
    "`cga_colors = colodore`",
    small=False
) }}
</div>
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/timequest-good.png",
    "Good",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/timequest-bad.png",
    "Bad",
    small=False
) }}
</div>
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/sq3-good.png",
    "Good",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/sq3-bad.png",
    "Bad",
    small=False
) }}
</div>
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/windwalker-good.png",
    "Good",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/windwalker-bad.png",
    "Bad",
    small=False
) }}
</div>
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/win31-non-hidpi.png",
    "Without high DPI support",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/win31-hidpi.png",
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/synced-cfr-earthworm-jim.png",
...
<div class="image-grid" markdown>
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/canadian-french.png",
    "Canadian French locale",
    small=False
) }}
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/united-states.png",
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/windows-installer-start.png",
    "Windows installer welome page",
    small=False
) }}

{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/windows-icons-after-installation.png",
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.79.0/tracy.png",
