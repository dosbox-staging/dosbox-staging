...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.75.0/heroes-of-might-and-magic-2-pixel-perfect.png",
    "[Heroes of Might and Magic II (1996)](https://en.wikipedia.org/wiki/Heroes_of_Might_and_Magic_II) --- 640&times;480 with a [pixel aspect ratio (PAR)](https://en.wikipedia.org/wiki/Pixel_aspect_ratio) of 1:1, upscaled to 2&times;2",
    small=False
) }}

{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.75.0/wolfenstein-3d-pixel-perfect.png",
    "[Wolfenstein 3D (1992)](https://en.wikipedia.org/wiki/Wolfenstein_3D) --- 320&times;200 with a PAR of 1:1.2 (non-square pixels), upscaled to 4&times;5 with a PAR of 1:1.25",
    small=False
) }}
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.75.0/battle-chess.png",
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.75.0/maniac-mansion-cga.png",
    "[Maniac Mansion (1988)](https://en.wikipedia.org/wiki/Maniac_Mansion) --- with forced CGA mode:<br>top-left: CGA, default palette;<br>top-right: CGA mono, green tint;<br>bottom-left: CGA composite, early model, default hue;<br>bottom-right: CGA composite, late model, default hue.",
    small=False
) }}
...
{{ figure(
    "https://www.dosbox-staging.org/static/images/release-notes/0.75.0/start-wars-x-wing-crt-shader.png",
    "[Star Wars(tm) --- X-Wing: Collector's CD-ROM Edition (1994)](https://en.wikipedia.org/wiki/Star_Wars:_X-Wing_(video_game_series)#Collector_Editions)<br>Using CRT-Lottes shader on a 1080p screen; click on the image to enlarge it to see the fine details. This shader is not bundled with DOSBox Staging (yet); you can download it from [here](https://github.com/tyrells/dosbox-svn-shaders).",
    small=False
) }}
